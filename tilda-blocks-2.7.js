...
$(document).ready(() => {
  ...
  switch (+password) {
    case 1:
      ...
      bottomText.text('Подтвердите, если сможете прийти. Также, если вы планируете остаться с ночевкой, сообщите нам об этом.<br />Подарок в конверте поможет нам осуществить мечту о свадебном путешествии. И пожалуйста, не дарите нам цветы, так как мы не успеем насладиться их красотой. Вместо этого мы будем рады бутылочке вина, которую вы можете украсить пожеланиями.<br />')
    ...
    case 2:
      ...
      dresscode.html(`<div class="t472__title t-section__title t-title t-title_md t-margin_auto" field="title" style="font-size:42px;">Дресс код</div>
          ...
          bottomText.text('Подтвердите, если сможете прийти. И уточните, как Вы будете добираться до базы отдыха, чтобы мы смогли забронировать для Вас место в трансфере. Также, если вы планируете остаться с ночевкой, сообщите нам об этом.<br />Подарок в конверте поможет нам осуществить мечту о свадебном путешествии. И пожалуйста, не дарите нам цветы, так как мы не успеем насладиться их красотой. Вместо этого мы будем рады бутылочке вина, которую вы можете украсить пожеланиями.')
      break;
    case 3:
